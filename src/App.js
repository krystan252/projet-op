          ...
          <body>
            <div className="box1">
              ...
              <div className="box2">
                ...
                <div className="boxc">
                  <a className="a1" href="/index1.html" target="_blank"> White paper</a>
                  <a className="a1" href="https://ftmscan.com/address/0xfa1fbb8ef55a4855e5688c0ee13ac3f202486286" target="_blank"> Contract</a>
                  <a className="a1" href="" target="_blank"> Discord</a>
                  <a className="a1" href="" target="_blank"> Telegram</a>
                  <a className="a1" href="" target="_blank"> Twitter</a>
                </div>
